...
<header>
	<div class="center">
		...
		<a <?php if(@$_GET['url'] == 'calendario'){ ?> style="background: #60727a;padding: 15px;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>calendario"><i class="fa fa-calendar" aria-hidden="true"></i> <span>Calendário</span></a>
			<a <?php if(@$_GET['url'] == 'chat'){ ?> style="background: #60727a;padding: 15px;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>chat"><i class="fa fa-comments-o" aria-hidden="true"></i> <span>Chat Online</span></a>
